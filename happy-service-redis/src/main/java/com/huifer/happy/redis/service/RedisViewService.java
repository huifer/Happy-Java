...
import com.huifer.happy.redis.entity.RedisValue;
...
public class RedisViewService {
     ...
     * @return
     */
    public List<String> queryKey(boolean isSystem) {
        if (isSystem) {
            // 只查询RedisKeys
            try {
                return getRedisKeys();
     ...
     * @return redis_keys
     */
    public List<String> getRedisKeys() throws IllegalAccessException {
